...
/// \file macro_eff_pur_jet_pT_min_N123.C
/// \brief Macro to plot the efficiency of b tagging with signed Impact Parameter (2D) and purity of c-lf jets vs. min jet pT. Uses the AO2D outputs of bjetTreeMerger.cxx
///
/// \author Clement Lotteau <clement.lotteau@cern.ch> IP2I

#include <math.h>

void macro_eff_pur_jet_pT_min_N123()
{
    ...
    mg->SetTitle("Efficiency and purity of sIP b-jet tagger - 1st largest IP; jet pT min (GeV/c); Efficiency and purities");
